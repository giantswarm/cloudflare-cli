...
- Read the [README.md](https://github.com/giantswarm/docker-cloudflare-cli/blob/master/README.md) for build instructions

## Reporting Bugs and Creating Issues

Reporting bugs is one of the best ways to contribute. If you find bugs or documentation mistakes in the Yochu project, please let us know by [opening an issue](https://github.com/giantswarm/docker-cloudflare-cli/issues/new). We treat bugs and mistakes very seriously and believe no issue is too small. Before creating a bug report, please check there that one does not already exist.
...
- Submit a pull request to giantswarm/docker-cloudflare-cli.
